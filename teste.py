...
def teste_api():
    ...
    try:
        ...
        print(f"   Dificuldade: {status['blockchain']['dificuldade']} zeros")
        ...
        print(f"   [OK] Blocos minerados em 10s: {blocos_minerados}")
        print(f"   Tempo médio/bloco: {tempo_meio_bloco:.2f}s")
        print(f"   Taxa: ~{blocos_minerados * 6}/minuto")
        
        # 5. Blockchain
        print("\n5. BLOCKCHAIN stats")
        print(f"   [OK] Total de blocos: {status_novo['blockchain']['trabalho_total']}")
